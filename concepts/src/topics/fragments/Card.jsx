      ...
      <div className="github-card">
        ...
        <div className="card-body">
          <div className="avatar-container">
            <img src={avatar_url} alt={`${login} avatar`} className="user-avatar"/>
          </div>
          
          <div className="badge-row">
            <span className="badge type-badge">{type}</span>
            <span className="badge status-badge">Member</span>
          </div>
          ...
          <div className="node-info-box">
            ...
            <code className="node-value">{node_id}</code>
          </div>

          <div className="card-actions">
            <a href={html_url} target="_blank" rel="noopener noreferrer"className="btn btn-primary">

              <svg className="github-icon" viewBox="0 0 24 24" width="14" height="14">
            ...
            <a href={repos_url} target="_blank" rel="noopener noreferrer"className="btn btn-secondary">
              Repos
            </a>
          </div>
        </div>
